...
import com.bupt.edu.test.other.User;
...
public class testJson {
    ...
    public static void main(String[] args) throws Exception {
        ...
        m.put("apus.job.slot.max.limit","5");
        m.put("apus.job.slot.min.limit","5");
        m.put("apus.job.slot.initial","5");
        m.put("apus.job.slot.estimate.strategy","require-max");

        Configuration configuration = Configuration.fromMap(m);
        String res =  MAPPER.writeValueAsString(m);
